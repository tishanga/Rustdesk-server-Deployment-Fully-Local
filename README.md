...
* Optionally install the internal HTTP server
...
```text
<REPLACE_WITH_CONFIGURATION_KEY>
```
...
* Optional auto‑detect LAN interface IP
* DHCP‑aware configuration
* TLS for internal HTTP installer
* Ansible / SCCM / GPO support
